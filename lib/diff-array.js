...
var diffArray = function (lastSeqArray, seqArray, callbacks) {
  ...
  // it appropriately.
  console.log('oldIdObjects', oldIdObjects);
  console.log('newIdObjects', newIdObjects);
...
var diffObjectChanges = function (oldItem, newItem) {
  ...
  if(_.isUndefined(oldItem)){
    ...
    angular.forEach(newItem, function (value, key) {
      ...
      if (key == '$$hashKey' || key == '$$originalCollection')
        return;
...
var diffObjectRemovals = function (oldItem, newItem) {
  console.log('diffObjectRemovals oldItem', oldItem);
  console.log('diffObjectRemovals newItem', newItem);
